...
@CommandParameters(description = "Quickly change your own gamemode to adventure, or set another player's gamemode to adventure.", usage = "/<command> <player | -a>", aliases = "gma")
